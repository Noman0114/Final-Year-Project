...
def res(resumes_data, job_data):
    ...
    print("Ordered List of Resumes:", Ordered_list_Resume)  # Add this line for debugging
    ...
    for indx, file in enumerate(Resume_Vector):
        ...
        if indx >= len(Ordered_list_Resume):
            print("Index out of range. Index:", indx, "Length of Ordered_list_Resume:", len(Ordered_list_Resume))
            break
        name = Ordered_list_Resume[indx]
        neigh = NearestNeighbors(n_neighbors=1)
        neigh.fit(samples)
